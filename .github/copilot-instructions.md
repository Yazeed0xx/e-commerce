...
always prioritize user experience, performance, and maintainability in your frontend solutions.
always use shadcn UI components and follow the shadcn design system for consistent styling and theming.
